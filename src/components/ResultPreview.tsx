...
const ResultPreview: React.FC<ResultPreviewProps> = ({ processedImageUrl }) => {
  ...
  useEffect(() => {
    ...
    // Create a new image from processed image URL
    const img = new Image();
  ...
  const getFilterInitialValue = (filterName: keyof FilterValues): number => {
    switch (filterName) {
      case 'brightness':
      case 'contrast':
      case 'saturate':
  ...
  return (
    <div className="border rounded-lg overflow-hidden p-4">
      <h3 className="text-lg font-medium mb-3">Result Preview</h3>
      <div className="bg-[#f1f1f1] rounded-lg overflow-hidden">
        <div className="relative w-full h-auto bg-[url('data:image/svg+xml;base64,')]">
          <img
            src={filteredImageUrl || processedImageUrl}
            alt="Processed"
